...
typedef enum
{
  ...
  HAL_SMBUS3 = (uint32_t)I2C3,                                           /*!< Peripheral instance I2C3 */
  HAL_SMBUS4 = (uint32_t)I2C4,                                           /*!< Peripheral instance I2C4 */
#if defined(I2C5)
  HAL_SMBUS5 = (uint32_t)I2C5,                                           /*!< Peripheral instance I2C5 */
#endif /* I2C5 */
#if defined(I2C6)
  HAL_SMBUS6 = (uint32_t)I2C6,                                           /*!< Peripheral instance I2C6 */
#endif /* I2C6 */
} hal_smbus_t;
...
/**
  * @brief SMBUS Autonomous Mode Trigger Selection
  */
typedef enum
{
  HAL_SMBUS_AM_TRIG_GRP1_GPDMA1_CH0_TC = LL_I2C_TRIG_GRP1_GPDMA1_CH0_TC, /*!< GPDMA1_CH0 */
  HAL_SMBUS_AM_TRIG_GRP1_GPDMA1_CH1_TC = LL_I2C_TRIG_GRP1_GPDMA1_CH1_TC, /*!< GPDMA1_CH1 */
  HAL_SMBUS_AM_TRIG_GRP1_GPDMA1_CH2_TC = LL_I2C_TRIG_GRP1_GPDMA1_CH2_TC, /*!< GPDMA1_CH2 */
  HAL_SMBUS_AM_TRIG_GRP1_GPDMA1_CH3_TC = LL_I2C_TRIG_GRP1_GPDMA1_CH3_TC, /*!< GPDMA1_CH3 */
  HAL_SMBUS_AM_TRIG_GRP1_EXTI5         = LL_I2C_TRIG_GRP1_EXTI5,         /*!< EXTI5 */
  HAL_SMBUS_AM_TRIG_GRP1_EXTI9         = LL_I2C_TRIG_GRP1_EXTI9,         /*!< EXTI9 */
  HAL_SMBUS_AM_TRIG_GRP1_LPTIM1_CH1    = LL_I2C_TRIG_GRP1_LPTIM1_CH1,    /*!< LPTIM1_CH1 */
  HAL_SMBUS_AM_TRIG_GRP1_LPTIM2_CH1    = LL_I2C_TRIG_GRP1_LPTIM2_CH1,    /*!< LPTIM2_CH1 */
  HAL_SMBUS_AM_TRIG_GRP1_COMP1_OUT     = LL_I2C_TRIG_GRP1_COMP1_OUT,     /*!< COMP1_OUT */
  HAL_SMBUS_AM_TRIG_GRP1_COMP2_OUT     = LL_I2C_TRIG_GRP1_COMP2_OUT,     /*!< COMP2_OUT */
  HAL_SMBUS_AM_TRIG_GRP1_RTC_ALRA_TRG  = LL_I2C_TRIG_GRP1_RTC_ALRA_TRG,  /*!< RTC_ALRA_TRG */
  HAL_SMBUS_AM_TRIG_GRP1_RTC_WUT_TRG   = LL_I2C_TRIG_GRP1_RTC_WUT_TRG,   /*!< RTC_WUT_TRG */

  HAL_SMBUS_AM_TRIG_GRP2_LPDMA1_CH0_TC = LL_I2C_TRIG_GRP2_LPDMA1_CH0_TC, /*!< LPDMA1_CH0 */
  HAL_SMBUS_AM_TRIG_GRP2_LPDMA1_CH1_TC = LL_I2C_TRIG_GRP2_LPDMA1_CH1_TC, /*!< LPDMA1_CH1 */
  HAL_SMBUS_AM_TRIG_GRP2_LPDMA1_CH2_TC = LL_I2C_TRIG_GRP2_LPDMA1_CH2_TC, /*!< LPDMA1_CH2 */
  HAL_SMBUS_AM_TRIG_GRP2_LPDMA1_CH3_TC = LL_I2C_TRIG_GRP2_LPDMA1_CH3_TC, /*!< LPDMA1_CH3 */
  HAL_SMBUS_AM_TRIG_GRP2_EXTI5         = LL_I2C_TRIG_GRP2_EXTI5,         /*!< EXTI5 */
  HAL_SMBUS_AM_TRIG_GRP2_EXTI8         = LL_I2C_TRIG_GRP2_EXTI8,         /*!< EXTI8 */
  HAL_SMBUS_AM_TRIG_GRP2_LPTIM1_CH1    = LL_I2C_TRIG_GRP2_LPTIM1_CH1,    /*!< LPTIM1_CH1 */
  HAL_SMBUS_AM_TRIG_GRP2_LPTIM3_CH1    = LL_I2C_TRIG_GRP2_LPTIM3_CH1,    /*!< LPTIM3_CH1 */
  HAL_SMBUS_AM_TRIG_GRP2_COMP1_OUT     = LL_I2C_TRIG_GRP2_COMP1_OUT,     /*!< COMP1_OUT */
  HAL_SMBUS_AM_TRIG_GRP2_COMP2_OUT     = LL_I2C_TRIG_GRP2_COMP2_OUT,     /*!< COMP2_OUT */
  HAL_SMBUS_AM_TRIG_GRP2_RTC_ALRA_TRG  = LL_I2C_TRIG_GRP2_RTC_ALRA_TRG,  /*!< RTC_ALRA_TRG */
  HAL_SMBUS_AM_TRIG_GRP2_RTC_WUT_TRG   = LL_I2C_TRIG_GRP2_RTC_WUT_TRG    /*!< RTC_WUT_TRG */
} hal_smbus_am_trig_source_t;

/**
  * @brief SMBUS Autonomous Mode Trigger Polarity
  */
typedef enum
{
  HAL_SMBUS_AM_TRIG_RISING       = LL_I2C_TRIG_POLARITY_RISING,          /*!< SMBUS HW Trigger signal on rising edge  */
  HAL_SMBUS_AM_TRIG_FALLING      = LL_I2C_TRIG_POLARITY_FALLING          /*!< SMBUS HW Trigger signal on falling edge */
} hal_smbus_am_trig_polarity_t;

/**
  * @brief SMBUS Autonomous Mode State
  */
typedef enum
{
  HAL_SMBUS_AM_TRIG_DISABLED  = 0U,                                      /*!< Autonomous mode disabled  */
  HAL_SMBUS_AM_TRIG_ENABLED   = 1U                                       /*!< Autonomous mode enabled   */
} hal_smbus_am_trig_status_t;

/**
  * @brief HAL SMBUS autonomous mode trigger config
  */
typedef struct
{
  hal_smbus_am_trig_source_t    source;                                  /*!< SMBUS Autonomous Mode Trigger Selection */
  hal_smbus_am_trig_polarity_t  trigger_polarity;                        /*!< SMBUS Autonomous Mode Trigger Polarity */
