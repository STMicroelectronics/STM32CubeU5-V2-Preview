...
#ifndef STM32U5XX_HAL_AES_H
#define STM32U5XX_HAL_AES_H
...
typedef enum
{
  ...
  HAL_SAES = (uint32_t)SAES /*!< SAES instance */
} hal_aes_t;
...
/*! AES key protection enumeration definition */
typedef enum
{
  HAL_AES_KEY_PROTECTION_ENABLED  = AES_CR_KEYPROT, /*!< Only for SAES, enable key protection between two applications
                                                         with a different security contexts, thus secure application
                                                         protects its own key from being accessed by another SAES
                                                         application */
  HAL_AES_KEY_PROTECTION_DISABLED = 0x00000000U     /*!< Only for SAES, disable Key protection between two applications
                                                         with a different security contexts */
} hal_aes_key_protection_status_t;
#endif /* USE_HAL_AES_ECB_CBC_ALGO */
...
#if (defined(USE_HAL_AES_GCM_GMAC_ALGO) && (USE_HAL_AES_GCM_GMAC_ALGO == 1)) \
     || (defined(USE_HAL_AES_CCM_ALGO) && (USE_HAL_AES_CCM_ALGO == 1))
  uint32_t                  SUSPxR[8];        /*!< Copy of suspension registers, used only in AES GCM and CCM
                                                   algorithms */
#endif /* USE_HAL_AES_GCM_GMAC_ALGO or USE_HAL_AES_CCM_ALGO */
...
{
  SET_BIT(((AES_TypeDef *)((uint32_t)haes->instance))->ICR, AES_ICR_RNGEIF);
}
#endif /* USE_HAL_AES_ECB_CBC_ALGO */
