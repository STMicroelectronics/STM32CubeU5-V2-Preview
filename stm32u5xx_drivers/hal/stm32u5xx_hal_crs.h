...
#ifndef STM32U5XX_HAL_CRS_H
#define STM32U5XX_HAL_CRS_H
...
/** @defgroup CRS_Trimming_Default_Value Trimming Default Value
  * @{
  */
#define HAL_CRS_TRIMMING_DEFAULT_VALUE  LL_CRS_HSI48CALIBRATION_DEFAULT /*!< The default value is 0x40U, which
...
typedef struct
{
  ...
  uint32_t trimming;                           /*!< Specifies a user-programmable trimming value to the HSI48
                                                    oscillator. This parameter must be a number between 0 and
                                                    0x7FU or @ref HAL_CRS_TRIMMING_DEFAULT_VALUE. */
