...
/**
  ...
  * @note Some data widths might not be supported for certain SPI instances
  *       You can refer to the reference manual to check the availability of
  *       data widths for each instance.
  */
typedef enum
{
...
#define HAL_SPI_AM_TRIG_GRP1                (0x10000000U)             /*!< Trigger Group for SPI1 and SPI2 */
#if defined(SPI3)
#define HAL_SPI_AM_TRIG_GRP2                (0x20000000U)             /*!< Trigger Group for SPI3 */
#endif /* SPI3 */

/**
  * @brief HAL SPI autonomous mode feature status enumeration definition
  */
typedef enum
{
  HAL_SPI_AM_TRIG_DISABLED = 0U,                       /*!<  Autonomous mode feature disabled */
  HAL_SPI_AM_TRIG_ENABLED  = 1U,                       /*!<  Autonomous mode feature enabled  */
} hal_spi_am_trig_status_t;

/**
  * @brief HAL SPI autonomous mode trigger selection enumeration definition
  */
typedef enum
{
  HAL_SPI_AM_TRIG_GRP1_GPDMA1_CH0_TC = LL_SPI_TRIG_GRP1_GPDMA1_CH0_TC, /*!< SPI1/SPI2 HW Trig signal is GPDMA1_CH0_TC */
  HAL_SPI_AM_TRIG_GRP1_GPDMA1_CH1_TC = LL_SPI_TRIG_GRP1_GPDMA1_CH1_TC, /*!< SPI1/SPI2 HW Trig signal is GPDMA1_CH1_TC */
  HAL_SPI_AM_TRIG_GRP1_GPDMA1_CH2_TC = LL_SPI_TRIG_GRP1_GPDMA1_CH2_TC, /*!< SPI1/SPI2 HW Trig signal is GPDMA1_CH2_TC */
  HAL_SPI_AM_TRIG_GRP1_GPDMA1_CH3_TC = LL_SPI_TRIG_GRP1_GPDMA1_CH3_TC, /*!< SPI1/SPI2 HW Trig signal is GPDMA1_CH3_TC */
  HAL_SPI_AM_TRIG_GRP1_EXTI4         = LL_SPI_TRIG_GRP1_EXTI4,         /*!< SPI1/SPI2 HW Trig signal is EXTI4         */
  HAL_SPI_AM_TRIG_GRP1_EXTI9         = LL_SPI_TRIG_GRP1_EXTI9,         /*!< SPI1/SPI2 HW Trig signal is EXTI9         */
  HAL_SPI_AM_TRIG_GRP1_LPTIM1_CH1    = LL_SPI_TRIG_GRP1_LPTIM1_CH1,    /*!< SPI1/SPI2 HW Trig signal is LPTIM1_CH1    */
  HAL_SPI_AM_TRIG_GRP1_LPTIM2_CH1    = LL_SPI_TRIG_GRP1_LPTIM2_CH1,    /*!< SPI1/SPI2 HW Trig signal is LPTIM2_CH1    */
  HAL_SPI_AM_TRIG_GRP1_COMP1_OUT     = LL_SPI_TRIG_GRP1_COMP1_OUT,     /*!< SPI1/SPI2 HW Trig signal is COMP1_OUT     */
  HAL_SPI_AM_TRIG_GRP1_COMP2_OUT     = LL_SPI_TRIG_GRP1_COMP2_OUT,     /*!< SPI1/SPI2 HW Trig signal is COMP2_OUT     */
  HAL_SPI_AM_TRIG_GRP1_RTC_ALRA_TRG  = LL_SPI_TRIG_GRP1_RTC_ALRA_TRG,  /*!< SPI1/SPI2 HW Trig signal is RTC_ALRA_TRG  */
  HAL_SPI_AM_TRIG_GRP1_RTC_WUT_TRG   = LL_SPI_TRIG_GRP1_RTC_WUT_TRG,   /*!< SPI1/SPI2 HW Trig signal is RTC_WUT_TRG   */
#if defined(IS_SPI_GRP2_INSTANCE)
  HAL_SPI_AM_TRIG_GRP2_LPDMA1_CH0_TC = LL_SPI_TRIG_GRP2_LPDMA1_CH0_TC, /*!< SPI3 HW Trig signal is LPDMA1_CH0_TC      */
  HAL_SPI_AM_TRIG_GRP2_LPDMA1_CH1_TC = LL_SPI_TRIG_GRP2_LPDMA1_CH1_TC, /*!< SPI3 HW Trig signal is LPDMA1_CH1_TC      */
  HAL_SPI_AM_TRIG_GRP2_LPDMA1_CH2_TC = LL_SPI_TRIG_GRP2_LPDMA1_CH2_TC, /*!< SPI3 HW Trig signal is LPDMA1_CH2_TC      */
  HAL_SPI_AM_TRIG_GRP2_LPDMA1_CH3_TC = LL_SPI_TRIG_GRP2_LPDMA1_CH3_TC, /*!< SPI3 HW Trig signal is LPDMA1_CH3_TC      */
  HAL_SPI_AM_TRIG_GRP2_EXTI4         = LL_SPI_TRIG_GRP2_EXTI4,         /*!< SPI3 HW Trig signal is EXTI4              */
  HAL_SPI_AM_TRIG_GRP2_EXTI8         = LL_SPI_TRIG_GRP2_EXTI8,         /*!< SPI3 HW Trig signal is EXTI8              */
  HAL_SPI_AM_TRIG_GRP2_LPTIM1_CH1    = LL_SPI_TRIG_GRP2_LPTIM1_CH1,    /*!< SPI3 HW Trig signal is LPTIM1_CH1         */
  HAL_SPI_AM_TRIG_GRP2_LPTIM3_CH1    = LL_SPI_TRIG_GRP2_LPTIM3_CH1,    /*!< SPI3 HW Trig signal is LPTIM3_CH1         */
  HAL_SPI_AM_TRIG_GRP2_COMP1_OUT     = LL_SPI_TRIG_GRP2_COMP1_OUT,     /*!< SPI3 HW Trig signal is COMP1_OUT          */
  HAL_SPI_AM_TRIG_GRP2_COMP2_OUT     = LL_SPI_TRIG_GRP2_COMP2_OUT,     /*!< SPI3 HW Trig signal is COMP2_OUT          */
  HAL_SPI_AM_TRIG_GRP2_RTC_ALRA_TRG  = LL_SPI_TRIG_GRP2_RTC_ALRA_TRG,  /*!< SPI3 HW Trig signal is RTC_ALRA_TRG       */
  HAL_SPI_AM_TRIG_GRP2_RTC_WUT_TRG   = LL_SPI_TRIG_GRP2_RTC_WUT_TRG,   /*!< SPI3 HW Trig signal is RTC_WUT_TRG        */
#endif /* IS_SPI_GRP2_INSTANCE */
} hal_spi_am_trig_source_t;

/**
  * @brief HAL SPI autonomous mode trigger polarity enumeration definition
  */
typedef enum
{
  HAL_SPI_AM_TRIG_RISING  = LL_SPI_AM_TRIG_RISING,  /*!< Autonomous trigger polarity
                                                                                      in the rising edge  */
  HAL_SPI_AM_TRIG_FALLING = LL_SPI_AM_TRIG_FALLING, /*!< Autonomous trigger polarity
                                                                                      in the falling edge */
} hal_spi_am_trig_polarity_t;

/**
  * @brief HAL SPI Autonomous mode configuration structure definition
  */
typedef struct
{
  hal_spi_am_trig_source_t     source;                      /*!<  Autonomous mode trigger source   */
  hal_spi_am_trig_polarity_t   polarity;                    /*!<  Autonomous mode trigger polarity */
...
/** @defgroup SPI_Exported_Functions_Group4 Autonomous Mode functions
  * @{
  */
