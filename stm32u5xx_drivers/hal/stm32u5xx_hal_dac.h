...
typedef enum
{
  ...
  HAL_DAC_TRIGGER_SOFTWARE    = LL_DAC_TRIGGER_SOFTWARE,   /*!< Conversion started by software trigger
                                                                for DAC channel */
  HAL_DAC_TRIGGER_TIM1_TRGO   = LL_DAC_TRIGGER_TIM1_TRGO,  /*!< TIM1 TRGO selected as external conversion trigger
                                                                for DAC channel */
  HAL_DAC_TRIGGER_TIM2_TRGO   = LL_DAC_TRIGGER_TIM2_TRGO,  /*!< TIM2 TRGO selected as external conversion trigger
                                                                for DAC channel */
  HAL_DAC_TRIGGER_TIM4_TRGO   = LL_DAC_TRIGGER_TIM4_TRGO,  /*!< TIM4 TRGO selected as external conversion trigger
                                                                for DAC channel */
  HAL_DAC_TRIGGER_TIM5_TRGO   = LL_DAC_TRIGGER_TIM5_TRGO,  /*!< TIM5 TRGO selected as external conversion trigger
                                                                for DAC channel */
  HAL_DAC_TRIGGER_TIM6_TRGO   = LL_DAC_TRIGGER_TIM6_TRGO,  /*!< TIM6 TRGO selected as external conversion trigger
                                                                 for DAC channel */
  HAL_DAC_TRIGGER_TIM7_TRGO   = LL_DAC_TRIGGER_TIM7_TRGO,  /*!< TIM7 TRGO selected as external conversion trigger
                                                                for DAC channel */
  HAL_DAC_TRIGGER_TIM8_TRGO   = LL_DAC_TRIGGER_TIM8_TRGO,  /*!< TIM8 TRGO selected as external conversion trigger
                                                                for DAC channel */
  HAL_DAC_TRIGGER_TIM15_TRGO  = LL_DAC_TRIGGER_TIM15_TRGO, /*!< TIM15 TRGO selected as external conversion trigger
                                                                for DAC channel */
  HAL_DAC_TRIGGER_LPTIM1_CH1  = LL_DAC_TRIGGER_LPTIM1_CH1, /*!< LPTIM1 CH1 selected as external conversion trigger
                                                                for DAC channel, this trigger can also
                                                                 be used in stop mode */
  HAL_DAC_TRIGGER_LPTIM3_CH1  = LL_DAC_TRIGGER_LPTIM3_CH1, /*!< LPTIM3 CH1 selected as external conversion trigger
                                                                for DAC channel, this trigger can also
                                                                be used in stop mode */
  HAL_DAC_TRIGGER_EXTI9       = LL_DAC_TRIGGER_EXTI9       /*!< EXTI Line9 event selected as external conversion
                                                                trigger for DAC channel, this trigger can also
                                                                be used in stop mode */
} hal_dac_trigger_t;
...
/**
  * @brief    DAC Autonomous mode status
  */
typedef enum
{
  HAL_DAC_AM_DISABLED = 0U, /*!< Autonomous mode is disabled */
  HAL_DAC_AM_ENABLED  = 1U  /*!< Autonomous mode is enabled  */
} hal_dac_am_status_t;
