...
#define SPI_LIMITED_FIFO_SIZE  8UL    /*!< Limited Instance fifo size 8-Bytes   */
...
/**
  ...
  */
#define IS_SPI_PACKET_SIZE(instance, packet_length) ((IS_SPI_LIMITED_INSTANCE(instance) ?        \
                                                      ((packet_length) <= SPI_LIMITED_FIFO_SIZE) : \
                                                      ((packet_length) <= SPI_FIFO_SIZE)))
...
/**
  ...
  */
#define IS_SPI_DATA_WIDTH(instance, width) ((IS_SPI_LIMITED_INSTANCE(instance) ? IS_SPI_LIMITED_DATA_WIDTH(width) :\
                                             IS_SPI_FULL_DATA_WIDTH(width)))

/**
  * @brief Check if the data width is type of hal_spi_data_width_t for full instances.
  */
#define IS_SPI_FULL_DATA_WIDTH(width)    (((width) == HAL_SPI_DATA_WIDTH_4_BIT)                    \
...
/**
  ...
  */
#define IS_SPI_CRC_LENGTH(instance, length) ((IS_SPI_LIMITED_INSTANCE(instance) ? IS_SPI_LIMITED_CRC_LENGTH(length) : \
                                              IS_SPI_FULL_CRC_LENGTH(length)))

#define IS_SPI_FULL_CRC_LENGTH(length)    (((length) == HAL_SPI_CRC_LENGTH_DATASIZE)               \
...
/**
  * @brief Check if the autonomous trigger is type of hal_spi_am_trig_status_t.
  */
#define IS_SPI_AUTONOMOUS_TRIG(state)    (((state) == HAL_SPI_AM_TRIG_DISABLED)               \
                                          || ((state) == HAL_SPI_AM_TRIG_ENABLED))
/**
  * @brief Check if the threshold is type of hal_spi_am_trig_source_t and TRIG_GRP1.
  */
#define IS_SPI_TRIG_GRP1(trig)    (((trig) == HAL_SPI_AM_TRIG_GRP1_GPDMA1_CH0_TC)                           \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_GPDMA1_CH1_TC)                        \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_GPDMA1_CH2_TC)                        \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_GPDMA1_CH3_TC)                        \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_EXTI4)                                \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_EXTI9)                                \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_LPTIM1_CH1)                           \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_LPTIM2_CH1)                           \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_COMP1_OUT)                            \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_COMP2_OUT)                            \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_RTC_ALRA_TRG)                         \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP1_RTC_WUT_TRG))

#if defined(HAL_SPI_AM_TRIG_GRP2)
/**
  * @brief Check if the autonomous trigger is type of hal_spi_am_trig_source_t and TRIG_GRP2.
  */
#define IS_SPI_TRIG_GRP2(trig)    (((trig) == HAL_SPI_AM_TRIG_GRP2_LPDMA1_CH0_TC)                           \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP2_LPDMA1_CH1_TC)                        \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP2_LPDMA1_CH2_TC)                        \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP2_LPDMA1_CH3_TC)                        \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP2_EXTI4)                                \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP2_EXTI8)                                \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP2_LPTIM1_CH1)                           \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP2_COMP1_OUT)                            \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP2_RTC_ALRA_TRG)                         \
                                   || ((trig) == HAL_SPI_AM_TRIG_GRP2_RTC_WUT_TRG))
#endif /* HAL_SPI_AM_TRIG_GRP2 */

/**
  * @brief Check if the autonomous trigger source is type of hal_spi_am_trig_polarity_t.
  */
#if defined(HAL_SPI_AM_TRIG_GRP1)&&defined(HAL_SPI_AM_TRIG_GRP2)
#define IS_SPI_AUTONOMOUS_TRIG_SOURCE(trig)    ((IS_SPI_TRIG_GRP1(trig))                              \
                                                || (IS_SPI_TRIG_GRP2(trig)))
#else /* HAL_SPI_AM_TRIG_GRP1 */

#define IS_SPI_AUTONOMOUS_TRIG_SOURCE(trig)    ((trig) == IS_SPI_TRIG_GRP1(trig))

#endif /* HAL_SPI_AM_TRIG_GRP1 && HAL_SPI_AM_TRIG_GRP2 */


/**
  * @brief Check if the autonomous trigger polarity is type of hal_spi_am_trig_polarity_t.
  */
#define IS_SPI_AUTONOMOUS_TRIG_POLARITY(polarity)    (((polarity) == HAL_SPI_AM_TRIG_RISING)      \
                                                      || ((polarity) == HAL_SPI_AM_TRIG_FALLING))
...
/**
  ...
  */
#define IS_SPI_TRANSFER_SIZE(instance, size) ((IS_SPI_LIMITED_INSTANCE(instance) ? IS_SPI_LIMITED_TRANSFER_SIZE(size) :\
                                               IS_SPI_FULL_TRANSFER_SIZE(size)))

/**
  * @brief Check if the transfer size is valid when crc is disabled for full instances.
  */
#define IS_SPI_FULL_TRANSFER_SIZE(size)        (((size) < 0xFFFF) && (size) != 0)

/**
  * @brief Check if the threshold is type of hal_spi_fifo threshold_t.
  */
#define IS_SPI_FIFO_THRESHOLD(instance, threshold) ((IS_SPI_LIMITED_INSTANCE(instance) ?        \
                                                     IS_SPI_LIMITED_FIFO_THRESHOLD(threshold) : \
                                                     IS_SPI_FULL_FIFO_THRESHOLD(threshold)))

/**
  * @brief Check if the threshold is type of hal_spi_fifo threshold_t for full instances.
  */
#define IS_SPI_FULL_FIFO_THRESHOLD(threshold)    (((threshold) == HAL_SPI_FIFO_THRESHOLD_1_DATA)                   \
...
/**
  * @brief Data Width for limited instance.
  */
#define IS_SPI_LIMITED_DATA_WIDTH(data_width)      (((data_width) == HAL_SPI_DATA_WIDTH_16_BIT)            \
                                                    || ((data_width) == HAL_SPI_DATA_WIDTH_8_BIT))
/**
  * @brief FifoThreshold for limited instance.
  */
#define IS_SPI_LIMITED_FIFO_THRESHOLD(threshold)   (((threshold) == HAL_SPI_FIFO_THRESHOLD_1_DATA)            \
                                                    || ((threshold) == HAL_SPI_FIFO_THRESHOLD_2_DATA)         \
                                                    || ((threshold) == HAL_SPI_FIFO_THRESHOLD_3_DATA)         \
                                                    || ((threshold) == HAL_SPI_FIFO_THRESHOLD_4_DATA)         \
                                                    || ((threshold) == HAL_SPI_FIFO_THRESHOLD_5_DATA)         \
...
/**
  ...
  */
#define IS_SPI_LIMITED_CRC_LENGTH(length)          (((length) == HAL_SPI_CRC_LENGTH_DATASIZE)                   \
                                                    || ((length) == HAL_SPI_CRC_LENGTH_8_BIT)                   \
                                                    || ((length) == HAL_SPI_CRC_LENGTH_16_BIT))
...
/**
  * @brief Check if the transfer size is valid when crc is disabled.
  */
#define IS_SPI_LIMITED_TRANSFER_SIZE(size)        (((size) < 0x3FF) && ((size) != 0))
...
hal_status_t HAL_SPI_SetConfig(hal_spi_handle_t *hspi, const hal_spi_config_t *p_config)
{
  ...
  ASSERT_DBG_PARAM(IS_SPI_DATA_WIDTH((SPI_TypeDef *)((uint32_t)hspi->instance), p_config->data_width));
...
/** @addtogroup SPI_Exported_Functions_Group3 Features functions
  * @{
  ...
  and Ready Pin management), there are those dedicated APIs:
...
hal_status_t HAL_SPI_SetConfigCRC(hal_spi_handle_t *hspi, const hal_spi_crc_config_t *p_config)
{
  ...
  ASSERT_DBG_PARAM(IS_SPI_CRC_LENGTH((SPI_TypeDef *)((uint32_t)hspi->instance), p_config->crc_length));
   ...
   */
  if (((IS_SPI_LIMITED_INSTANCE((SPI_TypeDef *)((uint32_t)hspi->instance)))
       && (length_crc == LL_SPI_CRC_LENGTH_16_BIT))
      || ((IS_SPI_FULL_INSTANCE((SPI_TypeDef *)((uint32_t)hspi->instance)))
          && (length_crc == LL_SPI_CRC_LENGTH_32_BIT)))
  {
...
/** @addtogroup SPI_Exported_Functions_Group4 Autonomous Mode functions
  * @{
  This subsection provides a set of functions allowing to use the autonomous mode feature for the SPIx instance.
  Prior to use the autonomous mode feature, one has to configure one's instance in asynchronous
  mode with HAL_SPI_SetConfig().
  A set of functions is provided to use the autonomous mode feature:
...
/**
  * @brief Configure the Autonomous mode feature.
  * @param hspi Pointer to a \ref hal_spi_handle_t structure which contains
  *             the SPI instance.
  * @param p_config Pointer to the hal_spi_am_trig_config_t data structure.
  * @retval HAL_INVALID_PARAM in case of invalid parameter allocation.
  * @retval HAL_OK in case of valid configuration.
  */
hal_status_t HAL_SPI_AM_SetConfigTrigger(const hal_spi_handle_t *hspi, const hal_spi_am_trig_config_t *p_config)
{
  ASSERT_DBG_PARAM(hspi != NULL);
  ASSERT_DBG_PARAM(p_config != NULL);

#if defined(USE_HAL_CHECK_PARAM) && (USE_HAL_CHECK_PARAM != 0U)
  if (p_config == NULL)
  {
    return HAL_INVALID_PARAM;
  }
  ...
  ASSERT_DBG_PARAM(IS_SPI_AUTONOMOUS_TRIG_SOURCE(p_config->source));
  ASSERT_DBG_PARAM(IS_SPI_AUTONOMOUS_TRIG_POLARITY(p_config->polarity));

  ASSERT_DBG_STATE(hspi->global_state, HAL_SPI_STATE_IDLE);

  /* SPIx AUTOCR Configuration */
  LL_SPI_SetAutonomousConfig(((SPI_TypeDef *)((uint32_t)hspi->instance)),
                             (((uint32_t)p_config->source & SPI_AUTOCR_TRIGSEL) |
                              ((uint32_t)p_config->polarity & SPI_AUTOCR_TRIGPOL)));

  return HAL_OK;
}

/**
  * @brief Retrieve the current autonomous mode configuration.
  * @param hspi Pointer to a \ref hal_spi_handle_t structure which contains
  *             the SPI instance.
  * @param p_config Pointer to the hal_spi_am_trig_config_t data structure.
  */
void HAL_SPI_AM_GetConfigTrigger(const hal_spi_handle_t *hspi, hal_spi_am_trig_config_t *p_config)
{
  uint32_t autocr_reg_value;
  ...
  autocr_reg_value = LL_SPI_READ_REG(((SPI_TypeDef *)((uint32_t)hspi->instance)), AUTOCR);

  /* Get Autonomous mode configuration */
  p_config->source   = (hal_spi_am_trig_source_t)((uint32_t)(autocr_reg_value & SPI_AUTOCR_TRIGSEL));
  p_config->polarity = (hal_spi_am_trig_polarity_t)((uint32_t)(autocr_reg_value & SPI_AUTOCR_TRIGPOL));
}

/**
  * @brief Enable the autonomous mode feature for the dedicated SPIx.
  * @param hspi Pointer to a \ref hal_spi_handle_t structure which contains
  *             the SPI instance.
  * @retval HAL_OK Autonomous mode feature enabled successfully.
  */
hal_status_t HAL_SPI_AM_EnableTrigger(const hal_spi_handle_t *hspi)
{
  ASSERT_DBG_PARAM(hspi != NULL);

  ASSERT_DBG_STATE(hspi->global_state, (uint32_t)HAL_SPI_STATE_IDLE);

  /* Enable the Autonomous mode */
  LL_SPI_Enable_SelectedTrigger((SPI_TypeDef *)((uint32_t)hspi->instance));

  return HAL_OK;
}

/**
  * @brief Disable the autonomous mode feature for the dedicated SPI.
  * @param hspi Pointer to a \ref hal_spi_handle_t structure which contains
  *             the SPI instance.
  * @retval HAL_OK Autonomous mode feature disabled successfully.
  */
hal_status_t HAL_SPI_AM_DisableTrigger(const hal_spi_handle_t *hspi)
{
  ASSERT_DBG_PARAM(hspi != NULL);

  ASSERT_DBG_STATE(hspi->global_state, HAL_SPI_STATE_IDLE);

  LL_SPI_Disable_SelectedTrigger((SPI_TypeDef *)((uint32_t)hspi->instance));

  return HAL_OK;
}

/**
  * @brief Retrieve the autonomous mode status for the dedicated SPI.
  * @param hspi Pointer to a \ref hal_spi_handle_t structure which contains
  *             the SPI instance.
  * @retval hal_spi_am_trig_status_t SPI autonomous mode feature status.
  */
hal_spi_am_trig_status_t HAL_SPI_AM_IsEnabledTrigger(const hal_spi_handle_t *hspi)
{
  ASSERT_DBG_PARAM(hspi != NULL);
  ...
  return (hal_spi_am_trig_status_t)LL_SPI_IsEnabled_SelectedTrigger((SPI_TypeDef *)((uint32_t)hspi->instance));
}
...
hal_status_t HAL_SPI_SetDataWidth(const hal_spi_handle_t *hspi, const hal_spi_data_width_t data_width)
{
  ...
  ASSERT_DBG_PARAM(IS_SPI_DATA_WIDTH((SPI_TypeDef *)((uint32_t)hspi->instance), data_width));
#if defined(USE_ASSERT_DBG_PARAM)
  /* Get PacketSize */
  uint32_t packet_length = GET_PACKET_SIZE(((uint32_t)data_width),
                                           LL_SPI_GetFIFOThreshold((SPI_TypeDef *)((uint32_t)hspi->instance)));
  ASSERT_DBG_PARAM(IS_SPI_PACKET_SIZE((SPI_TypeDef *)((uint32_t)hspi->instance), packet_length));
...
hal_status_t HAL_SPI_SetFifoThreshold(const hal_spi_handle_t *hspi, const hal_spi_fifo_threshold_t fifo_threshold)
{
  ...
  ASSERT_DBG_PARAM(IS_SPI_FIFO_THRESHOLD((SPI_TypeDef *)((uint32_t)hspi->instance), fifo_threshold));
#if defined(USE_ASSERT_DBG_PARAM)
  /* Get PacketSize */
...
hal_status_t HAL_SPI_Transmit(hal_spi_handle_t *hspi, const void *p_data, uint32_t count_packet, uint32_t timeout_ms)
{
...
#endif /* USE_HAL_CHECK_PARAM */
  ASSERT_DBG_PARAM(IS_SPI_TRANSFER_SIZE((SPI_TypeDef *)((uint32_t)hspi->instance), count_packet));
  ...
  if ((LL_SPI_IsEnabled_SelectedTrigger((SPI_TypeDef *)((uint32_t)hspi->instance)) == 0U)
  ...
  if ((data_width > LL_SPI_DATA_WIDTH_16_BIT) && (IS_SPI_FULL_INSTANCE((SPI_TypeDef *)((uint32_t)hspi->instance))))
  {
    /* Transmit data in 32 Bit mode */
