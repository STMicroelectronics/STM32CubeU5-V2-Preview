...
typedef enum
{
  ...
  HAL_COMP_INPUT_PLUS_IO4               = LL_COMP_INPUT_PLUS_IO4, /*!< Comparator input plus connected to IO4
                                        (for GPIO mapping, refer to datasheet parameters "COMPx_INP4") */
  HAL_COMP_INPUT_PLUS_IO5               = LL_COMP_INPUT_PLUS_IO5, /*!< Comparator input plus connected to IO5
                                        (for GPIO mapping, refer to datasheet parameters "COMPx_INP5") */
  HAL_COMP_INPUT_PLUS_IO6               = LL_COMP_INPUT_PLUS_IO6  /*!< Comparator input plus connected to IO6
                                        (for GPIO mapping, refer to datasheet parameters "COMPx_INP6") */
...
typedef enum
{
  ...
  HAL_COMP_INPUT_MINUS_DAC1_CH1         = LL_COMP_INPUT_MINUS_DAC1_CH1, /*!< Comparator input minus connected to
                                        DAC1 channel 1 */
  HAL_COMP_INPUT_MINUS_DAC1_CH2         = LL_COMP_INPUT_MINUS_DAC1_CH2, /*!< Comparator input minus connected to
                                        DAC1 channel 2 */
...
typedef enum
{
  ...
  HAL_COMP_OUTPUT_BLANK_TIM1_OC5        = LL_COMP_BLANKINGSRC_TIM1_OC5, /*!< Comparator output blanking source TIM1 OC5
                                        (specific to comparator instance: COMP1) */
  HAL_COMP_OUTPUT_BLANK_TIM2_OC3        = LL_COMP_BLANKINGSRC_TIM2_OC3, /*!< Comparator output blanking source TIM2 OC3
                                        (specific to comparator instance: COMP1) */
  HAL_COMP_OUTPUT_BLANK_TIM3_OC3        = LL_COMP_BLANKINGSRC_TIM3_OC3, /*!< Comparator output blanking source TIM3 OC3
                                        (specific to comparator instance: COMP1) */
  HAL_COMP_OUTPUT_BLANK_TIM3_OC4        = LL_COMP_BLANKINGSRC_TIM3_OC4, /*!< Comparator output blanking source TIM3 OC4
                                        (specific to comparator instance: COMP2) */
  HAL_COMP_OUTPUT_BLANK_TIM8_OC5        = LL_COMP_BLANKINGSRC_TIM8_OC5, /*!< Comparator output blanking source TIM8 OC5
                                        (specific to comparator instance: COMP2) */
  HAL_COMP_OUTPUT_BLANK_TIM15_OC1       = LL_COMP_BLANKINGSRC_TIM15_OC1 /*!< Comparator output blanking source TIM15 OC1
                                        (specific to comparator instance: COMP2) */
...
/**
  * @brief HAL COMP window instances assignation
  */
typedef enum
{
  HAL_COMP_WINDOW_INST_NONE             = (0x00000000UL), /*!< Comparators window instance not assigned */
  HAL_COMP_WINDOW_INST_UPPER            = (0x00000001UL), /*!< Comparators window instance assignation upper */
  HAL_COMP_WINDOW_INST_LOWER            = (0x00000002UL)  /*!< Comparators window instance assignation lower */
...
#if defined(COMP_WINDOW_MODE_SUPPORT)
#if defined(USE_HAL_COMP_WINDOW_MODE) && (USE_HAL_COMP_WINDOW_MODE == 1)
  hal_comp_handle_t                     *p_link_next_handle;  /*!< Pointer to another HAL COMP handle of instance belonging
                                        to the same COMP common instance (therefore, sharing common features).
                                        Used to access multiple HAL COMP handles (daisy chain: from one to another
                                        and circular).
                                        Set using function @ref HAL_COMP_WINDOW_SetHandle(). */
  hal_comp_window_instance_t            window_instance; /*!< Comparators window instance assignation */
#endif /* USE_HAL_COMP_WINDOW_MODE */
#endif /* COMP_WINDOW_MODE_SUPPORT */
