...
/** @defgroup LPUART_LL_EC_AUTOCR_TRIGSEL  Autonomous Trigger selection
  ...
  * @{
  */
#define LL_LPUART_TRIG_LPDMA1_CH0_TC    (uint32_t)(0U << USART_AUTOCR_TRIGSEL_Pos)   /*!< LPUART LPDMA1 channel0 Internal Trigger  */
#define LL_LPUART_TRIG_LPDMA1_CH1_TC    (uint32_t)(1U << USART_AUTOCR_TRIGSEL_Pos)   /*!< LPUART LPDMA1 channel1 Internal Trigger  */
#define LL_LPUART_TRIG_LPDMA1_CH2_TC    (uint32_t)(2U << USART_AUTOCR_TRIGSEL_Pos)   /*!< LPUART LPDMA1 channel2 Internal Trigger  */
#define LL_LPUART_TRIG_LPDMA1_CH3_TC    (uint32_t)(3U << USART_AUTOCR_TRIGSEL_Pos)   /*!< LPUART LPDMA1 channel3 Internal Trigger  */
#define LL_LPUART_TRIG_EXTI6            (uint32_t)(4U << USART_AUTOCR_TRIGSEL_Pos)   /*!< LPUART EXTI line 6 Internal Trigger      */
#define LL_LPUART_TRIG_EXTI8            (uint32_t)(5U << USART_AUTOCR_TRIGSEL_Pos)   /*!< LPUART EXTI line 8 Internal Trigger      */
#define LL_LPUART_TRIG_LPTIM1_CH1       (uint32_t)(6U << USART_AUTOCR_TRIGSEL_Pos)   /*!< LPUART LPTIM1 channel1 Internal Trigger  */
#define LL_LPUART_TRIG_LPTIM3_CH1       (uint32_t)(7U << USART_AUTOCR_TRIGSEL_Pos)   /*!< LPUART LPTIM3 channel1 Internal Trigger  */
#define LL_LPUART_TRIG_COMP1_OUT        (uint32_t)(8U << USART_AUTOCR_TRIGSEL_Pos)   /*!< LPUART COMP1 out Internal Trigger        */
#if defined(COMP2)
#define LL_LPUART_TRIG_COMP2_OUT        (uint32_t)(9U << USART_AUTOCR_TRIGSEL_Pos)   /*!< LPUART COMP2 out Internal Trigger        */
#endif /* COMP2 */
#define LL_LPUART_TRIG_RTC_ALRA_TRG     (uint32_t)(10U << USART_AUTOCR_TRIGSEL_Pos)  /*!< LPUART RTC alarm Internal Trigger        */
#define LL_LPUART_TRIG_RTC_WUT_TRG      (uint32_t)(11U << USART_AUTOCR_TRIGSEL_Pos)  /*!< LPUART RTC wakeup Internal Trigger       */
/**
  * @}
  */
...
/**
  ...
  * @rmtoll
  *  AUTOCR          TRIGEN          LL_LPUART_Enable_SelectedTrigger
  * @param  p_lpuart LPUART Instance
  */
__STATIC_INLINE void LL_LPUART_Enable_SelectedTrigger(USART_TypeDef *p_lpuart)
{
  SET_BIT(p_lpuart->AUTOCR, USART_AUTOCR_TRIGEN);
}

/**
  * @brief  Disable selected trigger.
  * @rmtoll
  *  AUTOCR          TRIGEN          LL_LPUART_Disable_SelectedTrigger
  * @param  p_lpuart LPUART Instance
  */
__STATIC_INLINE void LL_LPUART_Disable_SelectedTrigger(USART_TypeDef *p_lpuart)
{
  CLEAR_BIT(p_lpuart->AUTOCR, USART_AUTOCR_TRIGEN);
}

/**
  * @brief  Indicate if selected trigger is disabled or enabled.
  * @rmtoll
  *  AUTOCR          TRIGEN          LL_LPUART_IsEnabled_SelectedTrigger
  * @param  p_lpuart LPUART Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabled_SelectedTrigger(const USART_TypeDef *p_lpuart)
{
  return ((READ_BIT(p_lpuart->AUTOCR, USART_AUTOCR_TRIGEN) == (USART_AUTOCR_TRIGEN)) ? 1UL : 0UL);
}

/**
  * @brief  Enable autonomous send idle frame feature.
  * @rmtoll
  *  AUTOCR          IDLEDIS          LL_LPUART_Enable_AutonomousSendIdleFrame
  * @param  p_lpuart LPUART Instance
  */
__STATIC_INLINE void LL_LPUART_Enable_AutonomousSendIdleFrame(USART_TypeDef *p_lpuart)
{
  CLEAR_BIT(p_lpuart->AUTOCR, USART_AUTOCR_IDLEDIS);
}

/**
  * @brief  Disable autonomous send idle frame feature.
  * @rmtoll
  *  AUTOCR          IDLEDIS          LL_LPUART_Disable_AutonomousSendIdleFrame
  * @param  p_lpuart LPUART Instance
  */
__STATIC_INLINE void LL_LPUART_Disable_AutonomousSendIdleFrame(USART_TypeDef *p_lpuart)
{
  SET_BIT(p_lpuart->AUTOCR, USART_AUTOCR_IDLEDIS);
}

/**
  * @brief  Indicate if autonomous send idle frame feature is disabled or enabled.
  * @rmtoll
  *  AUTOCR          IDLEDIS          LL_LPUART_IsEnabled_AutonomousSendIdleFrame
  * @param  p_lpuart LPUART Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabled_AutonomousSendIdleFrame(const USART_TypeDef *p_lpuart)
{
  return ((READ_BIT(p_lpuart->AUTOCR, USART_AUTOCR_IDLEDIS) == (USART_AUTOCR_IDLEDIS)) ? 0UL : 1UL);
}

/**
  * @brief  Configure the number of transferred data in bytes.
  * @rmtoll
  *  AUTOCR        TDN     LL_LPUART_SetNbTxData
  * @param  p_lpuart LPUART Instance
  * @param  nb_data This parameter can be a value between 0 and 0xFFFF
  */
__STATIC_INLINE void LL_LPUART_SetNbTxData(USART_TypeDef *p_lpuart, uint32_t nb_data)
{
  MODIFY_REG(p_lpuart->AUTOCR, USART_AUTOCR_TDN, (uint16_t)nb_data);
}

/**
  * @brief  Retrieve the number of transferred data in bytes.
  * @rmtoll
  *  AUTOCR        TDN     LL_LPUART_GetNbTxData
  * @param  p_lpuart LPUART Instance
  * @retval Returned value can be a value between 0 and 0xFFFF
  */
__STATIC_INLINE uint32_t LL_LPUART_GetNbTxData(const USART_TypeDef *p_lpuart)
{
  return (uint32_t)(READ_BIT(p_lpuart->AUTOCR, USART_AUTOCR_TDN));
}

/**
  * @brief  Set the trigger polarity.
  * @rmtoll
  *  AUTOCR        TRIGPOL     LL_LPUART_SetTriggerPolarity
  * @param  p_lpuart LPUART Instance
  * @param  polarity This parameter can be one of the following values:
  *         @arg @ref LL_LPUART_TRIG_POLARITY_RISING
  *         @arg @ref LL_LPUART_TRIG_POLARITY_FALLING
  */
__STATIC_INLINE void LL_LPUART_SetTriggerPolarity(USART_TypeDef *p_lpuart, uint32_t polarity)
{
  MODIFY_REG(p_lpuart->AUTOCR, USART_AUTOCR_TRIGPOL, polarity);
}

/**
  * @brief  Get the trigger polarity.
  * @rmtoll
  *  AUTOCR        TRIGPOL     LL_LPUART_GetTriggerPolarity
  * @param  p_lpuart LPUART Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_LPUART_TRIG_POLARITY_RISING
  *         @arg @ref LL_LPUART_TRIG_POLARITY_FALLING
  */
__STATIC_INLINE uint32_t LL_LPUART_GetTriggerPolarity(const USART_TypeDef *p_lpuart)
{
  return (uint32_t)(READ_BIT(p_lpuart->AUTOCR, USART_AUTOCR_TRIGPOL));
}

/**
  * @brief  Set the selected trigger.
  * @rmtoll
  *  AUTOCR        TRIGSEL     LL_LPUART_SetSelectedTrigger
  * @param  p_lpuart LPUART Instance
  * @param  trigger This parameter can be one of the following values:
  *         @arg @ref  LL_LPUART_TRIG_LPDMA1_CH0_TC
  *         @arg @ref  LL_LPUART_TRIG_LPDMA1_CH1_TC
  *         @arg @ref  LL_LPUART_TRIG_LPDMA1_CH2_TC
  *         @arg @ref  LL_LPUART_TRIG_LPDMA1_CH3_TC
  *         @arg @ref  LL_LPUART_TRIG_EXTI6
  *         @arg @ref  LL_LPUART_TRIG_EXTI8
  *         @arg @ref  LL_LPUART_TRIG_LPTIM1_CH1
  *         @arg @ref  LL_LPUART_TRIG_LPTIM3_CH1
  *         @arg @ref  LL_LPUART_TRIG_COMP1_OUT
  *         @arg @ref  LL_LPUART_TRIG_COMP2_OUT
  *         @arg @ref  LL_LPUART_TRIG_RTC_ALRA_TRG
  *         @arg @ref  LL_LPUART_TRIG_RTC_WUT_TRG
  */
__STATIC_INLINE void LL_LPUART_SetSelectedTrigger(USART_TypeDef *p_lpuart, uint32_t trigger)
{
  MODIFY_REG(p_lpuart->AUTOCR, USART_AUTOCR_TRIGSEL, trigger);
}

/**
  * @brief  Get the selected trigger.
  * @rmtoll
  *  AUTOCR        TRIGSEL     LL_LPUART_GetSelectedTrigger
  * @param  p_lpuart LPUART Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref  LL_LPUART_TRIG_LPDMA1_CH0_TC
  *         @arg @ref  LL_LPUART_TRIG_LPDMA1_CH1_TC
  ...
  *         @arg @ref  LL_LPUART_TRIG_RTC_WUT_TRG
  */
__STATIC_INLINE uint32_t LL_LPUART_GetSelectedTrigger(const USART_TypeDef *p_lpuart)
{
  return (uint32_t)((READ_BIT(p_lpuart->AUTOCR, USART_AUTOCR_TRIGSEL)));
}
