...
/**
  ...
  * @note The default value is 0x40U, which corresponds to the middle of the trimming interval.
  *       The trimming step is specified in the product datasheet.
  *       A higher TRIM value corresponds to a higher output frequency.
  */
#define LL_CRS_HSI48CALIBRATION_DEFAULT    0x40U
...
/**
  ...
  * @param   crsx CRS instance
  * @param   value a number between Min_Data = 0 and Max_Data = 0x7FU.
  * @note    Default value can be set thanks to @ref LL_CRS_HSI48CALIBRATION_DEFAULT.
  * @warning When the AUTOTRIMEN bit is set, this field is controlled by hardware and is read-only.
  */
__STATIC_INLINE void LL_CRS_SetHSI48SmoothTrimming(CRS_TypeDef *crsx, uint32_t value)
{
...
/**
  ...
  * @param  crsx CRS instance.
  * @retval a number between Min_Data = 0 and Max_Data = 0x7FU.
  */
__STATIC_INLINE uint32_t LL_CRS_GetHSI48SmoothTrimming(const CRS_TypeDef *crsx)
{
...
/**
  ...
  * @param   crsx CRS instance.
  * @param   trimming a number between Min_Data = 0 and Max_Data = 0x7FU.
