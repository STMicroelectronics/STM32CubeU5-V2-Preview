...
/** @defgroup USART_LL_EC_AUTOCR_TRIGSEL Autonomous Mode Trigger Selection
  * @brief    USART Autonomous Trigger selection
  * @{
  */
#define LL_USART_TRIG_GPDMA1_CH0_TC      (uint32_t)(0U << USART_AUTOCR_TRIGSEL_Pos)                             /*!< USART GPDMA1 channel0 Internal Trigger  */
#define LL_USART_TRIG_GPDMA1_CH1_TC      (uint32_t)(1U << USART_AUTOCR_TRIGSEL_Pos)                             /*!< USART GPDMA1 channel1 Internal Trigger  */
#define LL_USART_TRIG_GPDMA1_CH2_TC      (uint32_t)(2U << USART_AUTOCR_TRIGSEL_Pos)                             /*!< USART GPDMA1 channel2 Internal Trigger  */
#define LL_USART_TRIG_GPDMA1_CH3_TC      (uint32_t)(3U << USART_AUTOCR_TRIGSEL_Pos)                             /*!< USART GPDMA1 channel3 Internal Trigger  */
#define LL_USART_TRIG_EXTI6              (uint32_t)(4U << USART_AUTOCR_TRIGSEL_Pos)                             /*!< USART EXTI line 6 Internal Trigger      */
#define LL_USART_TRIG_EXTI9              (uint32_t)(5U << USART_AUTOCR_TRIGSEL_Pos)                             /*!< USART EXTI line 9 Internal Trigger      */
#define LL_USART_TRIG_LPTIM1_CH1         (uint32_t)(6U << USART_AUTOCR_TRIGSEL_Pos)                             /*!< USART LPTIM1 channel1 Internal Trigger  */
#define LL_USART_TRIG_LPTIM2_CH1         (uint32_t)(7U << USART_AUTOCR_TRIGSEL_Pos)                             /*!< USART LPTIM2 channel1 Internal Trigger  */
#define LL_USART_TRIG_COMP1_OUT          (uint32_t)(8U << USART_AUTOCR_TRIGSEL_Pos)                             /*!< USART COMP1 out Internal Trigger        */
#if defined(COMP2)
#define LL_USART_TRIG_COMP2_OUT          (uint32_t)(9U << USART_AUTOCR_TRIGSEL_Pos)                             /*!< USART COMP2 out Internal Trigger        */
#endif /* COMP2 */
#define LL_USART_TRIG_RTC_ALRA_TRG       (uint32_t)(10U << USART_AUTOCR_TRIGSEL_Pos)                            /*!< USART RTC alarm Internal Trigger        */
#define LL_USART_TRIG_RTC_WUT_TRG        (uint32_t)(11U << USART_AUTOCR_TRIGSEL_Pos)                            /*!< USART RTC wakeup Internal Trigger       */
/**
  * @}
  */

/** @defgroup USART_LL_EC_AUTOCR_TRIGPOL Autonomous Mode Trigger Polarity
...
/**
  ...
  * @rmtoll
  *  AUTOCR          TRIGSEL         LL_USART_AM_ConfigPacketTrigger \n
  *  AUTOCR          TRIGPOL         LL_USART_AM_ConfigPacketTrigger \n
  *  AUTOCR          TDN             LL_USART_AM_ConfigPacketTrigger
  * @param  p_usart USART Instance
  * @param  polarity This parameter can be one of the following values:
  *         @arg @ref LL_USART_TRIG_POLARITY_RISING
  *         @arg @ref LL_USART_TRIG_POLARITY_FALLING
  * @param  source This parameter can be one of the following values:
  *         @arg @ref  LL_USART_TRIG_GPDMA1_CH0_TC
  *         @arg @ref  LL_USART_TRIG_GPDMA1_CH1_TC
  *         @arg @ref  LL_USART_TRIG_GPDMA1_CH2_TC
  *         @arg @ref  LL_USART_TRIG_GPDMA1_CH3_TC
  *         @arg @ref  LL_USART_TRIG_EXTI6
  *         @arg @ref  LL_USART_TRIG_EXTI9
  *         @arg @ref  LL_USART_TRIG_LPTIM1_CH1
  *         @arg @ref  LL_USART_TRIG_LPTIM2_CH1
  *         @arg @ref  LL_USART_TRIG_COMP1_OUT
  * @if COMP2
  *         @arg @ref  LL_USART_TRIG_COMP2_OUT
  * @endif
  *         @arg @ref  LL_USART_TRIG_RTC_ALRA_TRG
  *         @arg @ref  LL_USART_TRIG_RTC_WUT_TRG
  * @param  packet_size: This parameter can be a value between 0 and 0xFFFF
  */
__STATIC_INLINE void LL_USART_AM_ConfigPacketTrigger(USART_TypeDef *p_usart, uint32_t polarity, uint32_t source,
                                                     uint32_t packet_size)
{
  MODIFY_REG(p_usart->AUTOCR, (USART_AUTOCR_TRIGSEL | USART_AUTOCR_TRIGPOL | USART_AUTOCR_TDN),
             (polarity | source | packet_size));
}

/**
  * @brief  Enable Selected Trigger
  * @rmtoll
  *  AUTOCR          TRIGEN          LL_USART_Enable_SelectedTrigger
  * @param  p_usart USART Instance
  */
__STATIC_INLINE void LL_USART_Enable_SelectedTrigger(USART_TypeDef *p_usart)
{
  SET_BIT(p_usart->AUTOCR, USART_AUTOCR_TRIGEN);
}

/**
  * @brief  Disable Selected Trigger
  * @rmtoll
  *  AUTOCR          TRIGEN          LL_USART_Disable_SelectedTrigger
  * @param  p_usart USART Instance
  */
__STATIC_INLINE void LL_USART_Disable_SelectedTrigger(USART_TypeDef *p_usart)
{
  CLEAR_BIT(p_usart->AUTOCR, USART_AUTOCR_TRIGEN);
}

/**
  * @brief  Indicate if Selected Trigger is disabled or enabled
  * @rmtoll
  *  AUTOCR          TRIGEN          LL_USART_IsEnabled_SelectedTrigger
  * @param  p_usart USART Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabled_SelectedTrigger(const USART_TypeDef *p_usart)
{
  return ((READ_BIT(p_usart->AUTOCR, USART_AUTOCR_TRIGEN) == (USART_AUTOCR_TRIGEN)) ? 1UL : 0UL);
}

/**
  * @brief  Enable Autonomous Send Idle Frame feature
  * @rmtoll
  *  AUTOCR          IDLEDIS          LL_USART_Enable_AutonomousSendIdleFrame
  * @param  p_usart USART Instance
  */
__STATIC_INLINE void LL_USART_Enable_AutonomousSendIdleFrame(USART_TypeDef *p_usart)
{
  CLEAR_BIT(p_usart->AUTOCR, USART_AUTOCR_IDLEDIS);
}

/**
  * @brief  Disable Autonomous Send Idle Frame feature
  * @rmtoll
  *  AUTOCR          IDLEDIS          LL_USART_Disable_AutonomousSendIdleFrame
  * @param  p_usart USART Instance
  */
__STATIC_INLINE void LL_USART_Disable_AutonomousSendIdleFrame(USART_TypeDef *p_usart)
{
  SET_BIT(p_usart->AUTOCR, USART_AUTOCR_IDLEDIS);
}

/**
  * @brief  Indicate if Autonomous send Idle Frame feature is disabled or enabled
  * @rmtoll
  *  AUTOCR          IDLEDIS          LL_USART_IsEnabled_AutonomousSendIdleFrame
  * @param  p_usart USART Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabled_AutonomousSendIdleFrame(const USART_TypeDef *p_usart)
{
  return ((READ_BIT(p_usart->AUTOCR, USART_AUTOCR_IDLEDIS) == (USART_AUTOCR_IDLEDIS)) ? 0UL : 1UL);
}

/**
  * @brief  Configure the Number of transferred data in bytes
  * @rmtoll
  *  AUTOCR        TDN     LL_USART_SetNbTxData
  * @param  p_usart USART Instance
  * @param  Nbdata This parameter can be a value between 0 and 0xFFFF
  */
__STATIC_INLINE void LL_USART_SetNbTxData(USART_TypeDef *p_usart, uint32_t Nbdata)
{
  MODIFY_REG(p_usart->AUTOCR, USART_AUTOCR_TDN, (uint16_t)Nbdata);
}

/**
  * @brief  Retrieve the Number of transferred data in bytes
  * @rmtoll
  *  AUTOCR        TDN     LL_USART_GetNbTxData
  * @param  p_usart USART Instance
  * @retval Returned value can be a value between 0 and 0xFFFF
  */
__STATIC_INLINE uint32_t LL_USART_GetNbTxData(const USART_TypeDef *p_usart)
{
  return (uint32_t)(READ_BIT(p_usart->AUTOCR, USART_AUTOCR_TDN));
}

/**
  * @brief  Set the trigger polarity
  * @rmtoll
  *  AUTOCR        TRIGPOL     LL_USART_SetTriggerPolarity
  * @param  p_usart USART Instance
  * @param  polarity This parameter can be one of the following values:
  *         @arg @ref LL_USART_TRIG_POLARITY_RISING
  *         @arg @ref LL_USART_TRIG_POLARITY_FALLING
  */
__STATIC_INLINE void LL_USART_SetTriggerPolarity(USART_TypeDef *p_usart, uint32_t polarity)
{
  MODIFY_REG(p_usart->AUTOCR, USART_AUTOCR_TRIGPOL, polarity);
}

/**
  * @brief  Get the trigger polarity
  * @rmtoll
  *  AUTOCR        TRIGPOL     LL_USART_GetTriggerPolarity
  * @param  p_usart USART Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_USART_TRIG_POLARITY_RISING
  *         @arg @ref LL_USART_TRIG_POLARITY_FALLING
  */
__STATIC_INLINE uint32_t LL_USART_GetTriggerPolarity(const USART_TypeDef *p_usart)
{
  return (uint32_t)(READ_BIT(p_usart->AUTOCR, USART_AUTOCR_TRIGPOL));
}

/**
  * @brief  Set the selected trigger
  * @rmtoll
  *  AUTOCR        TRIGSEL     LL_USART_SetSelectedTrigger
  * @param  p_usart USART Instance
  ...
  *         @arg @ref  LL_USART_TRIG_RTC_WUT_TRG
  */
__STATIC_INLINE void LL_USART_SetSelectedTrigger(USART_TypeDef *p_usart, uint32_t trigger)
{
  MODIFY_REG(p_usart->AUTOCR, USART_AUTOCR_TRIGSEL, trigger);
}

/**
  * @brief  Get the selected trigger
  * @rmtoll
  *  AUTOCR        TRIGSEL     LL_USART_GetSelectedTrigger
  * @param  p_usart USART Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref  LL_USART_TRIG_GPDMA1_CH0_TC
  *         @arg @ref  LL_USART_TRIG_GPDMA1_CH1_TC
  ...
  *         @arg @ref  LL_USART_TRIG_RTC_WUT_TRG
  */
__STATIC_INLINE uint32_t LL_USART_GetSelectedTrigger(const USART_TypeDef *p_usart)
{
  return (uint32_t)(READ_BIT(p_usart->AUTOCR, USART_AUTOCR_TRIGSEL));
}
