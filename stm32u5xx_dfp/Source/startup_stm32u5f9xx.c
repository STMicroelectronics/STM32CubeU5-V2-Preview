/**
  ******************************************************************************
  * @file    startup_stm32u5f9xx.c
  * @brief   Startup File for STM32U5F9xx Device
  ******************************************************************************
  * @attention
  *
...
void GPU2D_SYS_IRQHandler(void) __attribute__((weak, alias("Default_IRQHandler")));
