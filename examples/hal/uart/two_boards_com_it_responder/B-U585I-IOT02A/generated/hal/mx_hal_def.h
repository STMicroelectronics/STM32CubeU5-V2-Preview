...
/* *********************************************************** */
/*        USART3_MyUART_1: aliases for initialization functions */
/* *********************************************************** */

/**
  * @brief  Initialize the mx_usart3_hal_uart with HAL layer
  *         Name of the User label:
  *                   MyUART_1
  *                   mx_example_uart
  * @retval hal_uart_handle_t Pointer on the handle on the USART3 instance
  */
#define myuart_1_init mx_usart3_hal_uart_init

#define mx_example_uart_init mx_usart3_hal_uart_init
...
/* *********************************************************** */
/*        USART3_MyUART_1: aliases for De-Initialization functions */
/* *********************************************************** */

/**
  * @brief  De-Initialize the mx_usart3_hal_uart with HAL layer
  *         Name of the User label:
  *                   MyUART_1
  *                   mx_example_uart
  */
#define myuart_1_deinit mx_usart3_hal_uart_deinit

#define mx_example_uart_deinit mx_usart3_hal_uart_deinit
...
/* *********************************************************** */
/*        USART3_MyUART_1: aliases for get handle functions */
/* *********************************************************** */
...
/**
  ...
  * @retval hal_uart_handle_t Pointer on the handle on the USART3 instance
  */
#define myuart_1_gethandle mx_usart3_hal_uart_gethandle

#define mx_example_uart_gethandle mx_usart3_hal_uart_gethandle
