...
/**
  * @brief  Initialize the mx_usart2_hal_uart with HAL layer
  *         Name of the User label:
  *                   MyUART_1
  *                   mx_example_uart
  * @retval hal_uart_handle_t Pointer on the handle on the USART2 instance
  */
#define myuart_1_init mx_usart2_hal_uart_init
...
/**
  * @brief  De-Initialize the mx_usart2_hal_uart with HAL layer
  *         Name of the User label:
  *                   MyUART_1
  *                   mx_example_uart
  */
#define myuart_1_deinit mx_usart2_hal_uart_deinit
