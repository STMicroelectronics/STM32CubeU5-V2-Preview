...
/* *********************************************************** */
/*        TIM3_MyTIM_1: aliases for initialization functions */
/* *********************************************************** */

/**
  * @brief  Initialize the mx_tim3_hal with HAL layer
  *         Name of the User label:
  *                   MyTIM_1
  *                   mx_example_tim
  * @retval hal_tim_handle_t Pointer on the handle on the TIM3 instance
  */
#define mytim_1_init mx_tim3_hal_init

#define mx_example_tim_init mx_tim3_hal_init
...
/* *********************************************************** */
/*        TIM3_MyTIM_1: aliases for De-Initialization functions */
/* *********************************************************** */

/**
  * @brief  De-Initialize the mx_tim3_hal with HAL layer
  *         Name of the User label:
  *                   MyTIM_1
  *                   mx_example_tim
  */
#define mytim_1_deinit mx_tim3_hal_deinit

#define mx_example_tim_deinit mx_tim3_hal_deinit
...
/* *********************************************************** */
/*        TIM3_MyTIM_1: aliases for get handle functions */
/* *********************************************************** */
...
/**
  ...
  * @retval hal_tim_handle_t Pointer on the handle on the TIM3 instance
  */
#define mytim_1_gethandle mx_tim3_hal_gethandle

#define mx_example_tim_gethandle mx_tim3_hal_gethandle
