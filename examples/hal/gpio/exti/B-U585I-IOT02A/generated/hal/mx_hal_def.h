...
#define mx_example_exti_trigger_init mx_gpio_default_hal_init
...
#define mx_example_exti_trigger_deinit mx_gpio_default_hal_deinit
...
/**
  ...
  *         Name of the User label:
  *                   user_button (user label)
  *                   mx_example_exti_trigger (user label)
  * @retval hal_exti_handle_t Pointer on the handle on the EXTI instance
  */
#define user_button_exti_gethandle   mx_gpio_exti13_gethandle
#define mx_example_exti_trigger_exti_gethandle   user_button_exti_gethandle
