...
system_status_t mx_gpio_default_hal_init(void)
{
  ...
  /* PE13  --------->  ARD_D13_SPI1_SCK */

  gpio_config.mode            = HAL_GPIO_MODE_OUTPUT;
  gpio_config.speed           = HAL_GPIO_SPEED_FREQ_LOW;
  gpio_config.pull            = HAL_GPIO_PULL_NO;
  gpio_config.output_type     = HAL_GPIO_OUTPUT_PUSHPULL;
  gpio_config.init_state      = ARD_D13_SPI1_SCK_INIT_STATE;

  if (HAL_GPIO_Init(ARD_D13_SPI1_SCK_GPIO_PORT, ARD_D13_SPI1_SCK_PIN, &gpio_config) != HAL_OK)
  {
  ...
  gpio_config.pull            = HAL_GPIO_PULL_NO;
  if (HAL_GPIO_Init(USER_BUTTON_GPIO_PORT, USER_BUTTON_PIN, &gpio_config) != HAL_OK)
  {
    return SYSTEM_PERIPHERAL_ERROR;
  }
...
system_status_t mx_gpio_default_hal_deinit(void)
{
  ...
  HAL_GPIO_DisableHighSpeedLowVoltage(ARD_D13_SPI1_SCK_GPIO_PORT, ARD_D13_SPI1_SCK_PIN);
