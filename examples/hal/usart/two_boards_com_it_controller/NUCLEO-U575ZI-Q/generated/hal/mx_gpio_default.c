...
system_status_t mx_gpio_default_cfg1_hal_init(void)
{
  ...
  HAL_GPIO_WritePin(HAL_GPIOC, HAL_GPIO_PIN_7, HAL_GPIO_PIN_RESET);

  gpio_config.mode            = HAL_GPIO_MODE_OUTPUT;
  gpio_config.speed           = HAL_GPIO_SPEED_FREQ_HIGH;
  gpio_config.pull            = HAL_GPIO_PULL_NO;
  gpio_config.output_type     = HAL_GPIO_OUTPUT_PUSHPULL;
  if (HAL_GPIO_Init(HAL_GPIOC, HAL_GPIO_PIN_7, &gpio_config) != HAL_OK)
  {
...
{
  HAL_GPIO_DeInit(HAL_GPIOC, HAL_GPIO_PIN_7);
